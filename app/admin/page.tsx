...
import { FileText, Video, Mail, Users, PlusCircle } from 'lucide-react'
...
export default async function AdminDashboard() {
    ...
    const [{ count: postCount }, { count: talkCount }, { count: contactCount }, { count: userCount }] =
        await Promise.all([
    ...
    const stats = [
        { label: 'Blog posts', value: postCount ?? 0, icon: FileText, href: '/admin/blog', color: 'text-blue-600 bg-blue-50' },
        ...
        <div className="section">
            <div className="container-lg">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                        { href: '/admin/blog', label: 'Manage Blog Posts', desc: 'Create, edit, publish articles' },
                        { href: '/admin/talks', label: 'Manage Talks', desc: 'Add or update talks and videos' },
